...
% Define personal BeraMonott font environment
% for inline code because inline listing is a pain
%\newenvironment{myfont}{\fontfamily{\BeraMonottfamily}\selectfont}{\par}
%\DeclareTextFontCommand{\textmyfont}{\myfont}

\lstset{ %
  backgroundcolor=\color{RawSienna!5},   % choose the background color; you must add \usepackage{color} or \usepackage{xcolor}; should come as last argument
  ...
  numberstyle=\color{Maroon}, % the style that is used for the line-numbers
...
\hypersetup{%
  ...
  colorlinks=true, linktoc=all,%linktocpage=true,%
...
\KOMAoptions{headinclude=true,footinclude=false,fontsize=11pt}
%\setlength{\textwidth}{10.5cm} % 9 pt font
%\setlength{\textwidth}{11.6cm} % 10 pt font
\setlength{\textwidth}{16cm} % 12 pt font
